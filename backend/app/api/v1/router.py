...
#   from app.api.v1.routes import auth, documents, query, audit, eval, admin
#   api_router.include_router(auth.router)      # Step 3
#   api_router.include_router(documents.router) # Step 6
#   api_router.include_router(query.router)     # Step 9
#   api_router.include_router(audit.router)     # Step 4
#   api_router.include_router(eval.router)      # Step 10
#   api_router.include_router(admin.router)     # Step 3
